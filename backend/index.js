        ...
        messages: [
          {
            role: 'system',
            content:
              'Create a production deployment checklist for a [type of application] built using [tech stack]. The checklist should cover deployment-phase steps, including security, monitoring, rollback plans. Ensure to include IP whitelisting steps specifically for AWS services. Format it as a detailed, bullet-pointed list that can be used by DevOps or engineering teams.',
          },
          {
            role: 'user',
            content: `Provide a detailed production deployment checklist for a ${tech} application.`,
